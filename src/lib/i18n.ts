...
export const bookAStandTranslations = {
  en: {
    ...
    success:
      "Your stand booking request has been submitted! We'll be in touch shortly.",
    termsCheckbox:
  ...
  ar: {
    title: "احجز جناحاً",
    subtitle:
      "احجز جناحك في معرض تكسبو وتواصل مع الآلاف من قادة الصناعة والمستثمرين والمبتكرين.",
    fields: {
...
export const sponsorsTranslations = {
  en: {
    strategic_partners: "GOVERNMENT SPONSOR",
    normal_sponsors: "SPONSORS",
  },
  ar: {
    strategic_partners: "الرعاة الاستراتيجيين",
    normal_sponsors: "الرعاة",
  },
} as const;
